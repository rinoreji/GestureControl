...
namespace MouseGestures
{
    ...
    public partial class MouseGestures
    {
        ...
        public void AddToGesture(object sender, EventArgs e)
        {
            if (gesture != null)
            {
                ...
                {
                    var direction = GetDirection(lastPoint, point);
                    gesture.AddSegment(direction);
                    if (DirectionAdded != null)
                    {
                        MouseGestureEventArgs args = new MouseGestureEventArgs(gesture);
                        DirectionAdded(sender, args);
                    }
        ...
        public delegate void DirectionAddedHandler(object sender, MouseGestureEventArgs e);

        /// <summary>
        /// Occurs whether valid mouse gesture is performed.
        /// </summary>
        public event GestureHandler Gesture;
        public event DirectionAddedHandler DirectionAdded;
